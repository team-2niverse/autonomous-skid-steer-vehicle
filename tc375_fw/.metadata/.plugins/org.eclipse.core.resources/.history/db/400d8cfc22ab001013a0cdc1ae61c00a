...
//        err_t err;
        ...
        Encoder_Set_IntCnt_Right(0);
        Encoder_Set_IntCnt_Left(0);
        Encoder_Set_DiffSum_Right(0);
        Encoder_Set_DiffSum_Left(0);
