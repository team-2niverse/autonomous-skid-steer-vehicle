...
{
    /* Start the GPT12 timer (T4) for the 1ms LwIP tick */
    Gpt12_Run_Gpt1_T4();
...
/* This interrupt is raised by the GPT12 T4 timer */
IFX_INTERRUPT(Lwip_Gpt1_T4_Isr_Handler, 0, ISR_PRIORITY_GPT1T4_TIMER);

/* ISR to update LwIP stack every 1ms */
void Lwip_Gpt1_T4_Isr_Handler(void)
{
