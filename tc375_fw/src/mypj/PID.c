...
//volatile int left_speed_goal = 0;
//volatile int right_speed_goal = 0;
//
//volatile int prev_left_encoder=0;
//volatile int prev_right_encoder=0;
//
//
//int overshoot = 0;
//int undershoot = 0;
...
//void Timer_ISR(void)
//{
//    int left_speed_goal = get_speed_left(); //from 4 wheel model
//    int right_speed_goal = get_speed_right();
//    int left_encoder = get_encoder_left();
//    int right_encoder = get_encoder_right();
//
//    left_speed_value = (left_encoder - prev_left_encoder);  // 속도 계산('tick' 단위)
//    right_speed_value = (right_encoder - prev_right_encoder);
//    prev_left_encoder = left_encoder;
//    prev_right_encoder = right_encoder;
//
//    // 오차
//    int left_e_value = left_speed_goal - speed_value;
//    int right_e_value = right_speed_goal - right_speed_value;
//
//    // PID 계산
...
//    // PWM값 보정 (0-255 확장)
//    if (speed_goal >= 0) {
//        pwm_value = map(PID_control, 0, 60*K_p, 90, 255);
//        nolimit = pwm_value;
//        pwm_value = constrain(pwm_value, 90, 255);
//        limit = pwm_value;
//    } else {
//        pwm_value = map(-PID_control, 0, 60*K_p, 90, 255);
//        pwm_value = constrain(pwm_value, 90, 255);
